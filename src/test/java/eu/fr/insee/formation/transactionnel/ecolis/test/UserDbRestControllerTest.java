...
public class UserDbRestControllerTest {
	...
	public void testGetUserById() throws Exception {
	  Integer id = 2;
	  EcolisUserDto foundUser = new RestTemplate().getForObject(ECOLIS_URI_PREFIX+"/users/{userId}", EcolisUserDto.class, id);
	...
	public void testGetAllUsers() throws Exception {
		...
		ResponseEntity<List<EcolisUserDto>> response = restTemplate.exchange(
				ECOLIS_URI_PREFIX+"/users",
		  HttpMethod.GET,
		  null,
		  new ParameterizedTypeReference<List<EcolisUserDto>>(){});
		List<EcolisUserDto> userList = response.getBody();
	...
	public void testCreateUser() throws Exception {
		RestTemplate restTemplate = new RestTemplate();
		EcolisUserDto userACreer = new EcolisUserDto();
